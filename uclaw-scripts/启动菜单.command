...
do_china_models() {
    ...
    echo ""
    echo -e "  OpenClaw 已内置以下国产模型支持:"
    echo ""
    echo -e "  ${GREEN}[a]${NC} DeepSeek（深度求索）    — 性价比最高，推荐首选"
    ...
    echo -e "  ${GREEN}[g]${NC} 百度千帆                  — 百度智能云"
    echo -e "  ${GREEN}[h]${NC} 小米 Mimo                — 小米 AI"
    echo ""
    echo -e "  ${YELLOW}请选择要配置的模型 (a-h):${NC} "
